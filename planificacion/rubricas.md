...
## 1. Rúbrica para Exámenes

### 1.1 Rúbrica Examen Teórico (Unidades 1 y 3)

**Propósito:** Evaluar comprensión de conceptos teóricos de POO y desarrollo backend.
...
|----------|-------------------|---------------|----------------------|-------------------|------|
| **Comprensión de Conceptos** | Demuestra comprensión profunda; explica con ejemplos propios; conexiones entre conceptos | Comprende conceptos principales; explica correctamente; ejemplos adecuados | Comprende conceptos básicos; explicaciones simples; ejemplos genéricos | No comprende conceptos; explicaciones confusas; sin ejemplos | 25% |
| **Precisión Terminológica** | Usa términos técnicos correctamente; vocabulario preciso y profesional | Usa términos correctamente; vocabulario adecuado | Algunos términos incorrectos; vocabulario básico | Términos incorrectos; vocabulario impreciso | 15% |
| **Análisis y Síntesis** | Analiza problemas desde múltiples ángulos; sintetiza información compleja | Analiza problemas adecuadamente; sintetiza información correctamente | Análisis básico; síntesis limitada | Sin análisis; información fragmentada | 20% |
| **Aplicación Práctica** | Aplica conceptos a escenarios reales; soluciones innovadoras | Aplica conceptos correctamente; soluciones adecuadas | Aplica conceptos básicamente; soluciones simples | No aplica conceptos; soluciones incorrectas | 25% |
| **Claridad y Organización** | Respuestas claras y bien estructuradas; excelentes ejemplos | Respuestas claras; buena estructura | Respuestas algo confusas; estructura básica | Respuestas confusas; sin estructura | 15% |
...
### 1.2 Rúbrica Examen Práctico (Unidades 1, 2, 3)
...
### 5.1 Distribución de Ponderación

| Componente | Peso | Nota Base |
|------------|------|-----------|
| Evaluación 1 (Unidad 1) | 15% | Examen teórico-práctico |
| Evaluación 2 (Unidad 2) | 15% | Taller + sustentación |
| Evaluación 3 (Unidad 3) | 20% | Examen práctico + API |
| Evaluación 4 (Unidad 4) | 15% | Taller + sustentación |
| Proyecto Final (Unidad 5) | 20% | Sistema + sustentación |
