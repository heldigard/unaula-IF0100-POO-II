...
|
|-- clases-html/               # Contenido HTML de teoria (clases)
|
...
|--------|--------|--------|---------|
| 0 | 3 | Fundamentos de Python | Repaso intensivo |
...
| 4 | 5 | Persistencia de Datos | JSON, CSV, SQLAlchemy, Alembic |
| 5 | 5 | Arquitectura de Software | Repository Pattern, Clean Architecture |

**Total:** 26 clases (Martes y Jueves, Febrero - Mayo 2026)
...
```
Primer Seguimiento (50%): 15% + 15% + 20% (Entregas 1, 2 y 3)
Segundo Seguimiento (80%): +15% + 15% (Entregas 4 y 5)
Tercer Seguimiento (100%): +20% (Sustentación Final)
```

| Seguimiento | Evaluacion | Peso | Fecha | Entregable Incremental |
|-------------|------------|------|-------|-------------------------|
| **Primer (50%)** | E1 - Taller | 15% | 26/02/2026 | **Entrega 1:** Modelado de Dominio |
| **Primer (50%)** | E2 - Laboratorio | 15% | 12/03/2026 | **Entrega 2:** Testing y Calidad |
| **Primer (50%)** | E3 - Prototipo | 20% | 26/03/2026 | **Entrega 3:** API Web Básica |
| **Segundo (80%)** | E4 - Software | 15% | 23/04/2026 | **Entrega 4:** Persistencia Local |
| **Segundo (80%)** | E5 - Software | 15% | 07/05/2026 | **Entrega 5:** Persistencia SQL |
| **Tercer (100%)** | E6 - Proyecto | 20% | 28/05/2026 | **Final:** Sustentación Sistema Completo |
